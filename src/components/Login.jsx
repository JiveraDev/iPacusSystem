                ...
                <form onSubmit={handleSubmit} className="px-6 pt-4 pb-6 space-y-4">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="min-h-11 w-full rounded-lg border-0 bg-[#f3f3f5] px-3 py-2 text-[16px] leading-5 text-[#0a0a0a] outline-none placeholder:text-[#717182] focus:ring-2 focus:ring-[#155dfc]"
