-- iPawcus deployed-database SQL bundle for required changes after July 10.
-- Target: MariaDB 10.4+ / MySQL-compatible servers.
--
-- Before importing:
-- 1. Select the intended iPawcus database.
-- 2. Take a full database backup.
-- 3. Pause application writes for the maintenance window.
--
-- Safe to rerun. This bundle contains the required schema/integrity changes,
-- preserves legacy allergy values, and adds the Special Services exact-price
-- column. It intentionally excludes production-data repairs that require
-- operator review:
--   - 20260723_03a / 20260723_03b historical visit reconstruction
--   - 20260727_02a / 20260727_02b clinical propagation cleanup
--
-- Run those preview/write pairs separately only after reviewing their
-- production result sets and following the repository runbooks.
-- #########################################################################
-- Bundled source: 20260723_01_backend_integrity_schema.sql
-- #########################################################################
...
-- #########################################################################
-- Bundled source: 20260723_02_pet_allergy_backfill.sql
-- #########################################################################
...
-- #########################################################################
-- Bundled source: 20260727_01_special_service_billing_price.sql
-- #########################################################################
