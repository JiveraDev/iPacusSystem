...
try {
    ...
    $formattedBookings = array_map(function($b) use ($specialServiceItemsByBooking, $pdo) {
        ...
        return [
            ...
            'admissionType' => $b['admission_type'] ?? 'regular',
            'sourceVisitId' => isset($b['source_visit_id']) && $b['source_visit_id'] !== null ? (int)$b['source_visit_id'] : null,
            'sourceDiagnosisId' => isset($b['source_diagnosis_id']) && $b['source_diagnosis_id'] !== null ? (int)$b['source_diagnosis_id'] : null,
            'sourceGroomingBookingId' => isset($b['source_grooming_booking_id']) && $b['source_grooming_booking_id'] !== null ? (int)$b['source_grooming_booking_id'] : null,
            'referredByVetUserId' => isset($b['referred_by_vet_user_id']) && $b['referred_by_vet_user_id'] !== null ? (int)$b['referred_by_vet_user_id'] : null,
            'confinementReason' => $b['confinement_reason'] ?? null,
            'careInstructions' => $b['care_instructions'] ?? null,
            'ownerApprovalStatus' => $b['owner_approval_status'] ?? null,
            'ownerApprovedAt' => $b['owner_approved_at'] ?? null,
