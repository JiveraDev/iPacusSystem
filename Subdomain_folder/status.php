...
function tv_fetch_queue(PDO $pdo, string $today, array &$completed): array
{
...
function tv_fetch_bookings(PDO $pdo, string $today): array
{
...
function tv_fetch_billing(PDO $pdo, string $today, array &$completed): array
{
...
try {
    ...
    $sections['queue'] = tv_fetch_queue($pdo, $today, $sections['completed']);
    $sections['bookings'] = tv_fetch_bookings($pdo, $today);
    $sections['billing'] = tv_fetch_billing($pdo, $today, $sections['completed']);
