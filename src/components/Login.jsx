                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="hide-native-password-toggle h-11 min-h-11 w-full appearance-none bg-[#f3f3f5] border-0 rounded-lg px-3 py-0 pr-10 text-[16px] leading-5 text-[#0a0a0a] placeholder:text-[#717182] focus:ring-2 focus:ring-[#155dfc] outline-none"
                            ...
                            <button
                                ...
                                className="absolute right-2 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-md text-[#717182] hover:text-[#0a0a0a]"
